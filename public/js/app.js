...
const daysTemplate = Object(_lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["optimizeTemplateHTML"])(`<div class="days">
  ...
  <div class="datepicker-grid w-64 grid grid-cols-7">${Object(_lib_utils_js__WEBPACK_IMPORTED_MODULE_0__["createTagRepeat"])('span', 42 , {class: 'block flex-1 leading-9 border-0 rounded-lg cursor-default text-center text-gray-900 font-semibold text-sm h-6 leading-6 text-sm font-medium text-gray-500 dark:text-gray-400'})}</div>
</div>`);
...
/* harmony import */ var _themesberg_tailwind_datepicker_js_Datepicker_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @themesberg/tailwind-datepicker/js/Datepicker.js */ "./node_modules/@themesberg/tailwind-datepicker/js/Datepicker.js");
...
var datepickerEl = document.getElementById('date');
new _themesberg_tailwind_datepicker_js_Datepicker_js__WEBPACK_IMPORTED_MODULE_1__["default"](datepickerEl, {
  format: 'dd/mm/yyyy',
  autohide: true
});
