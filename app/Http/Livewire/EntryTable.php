...
final class EntryTable extends PowerGridComponent
{
    use ActionButton;
    ...
    *
    * @return Builder<\App\Models\Entry>
    */
    ...
    */
     ...
     /**
     * PowerGrid Entry Action Buttons.
     *
